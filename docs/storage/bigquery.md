...
| --- | --- |
| `project_id` | `POSTURE_BIGQUERY_PROJECT_ID` |
| `dataset_id` | `POSTURE_BIGQUERY_DATASET_ID` |
...
write_storage(df, "bigquery", "table_name", config={ ... })
```
...
store = open_storage("bigquery", config={ ... })
